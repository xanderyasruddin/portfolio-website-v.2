  ...
  return (
    <div>
      <div className='block lg:hidden'>
        ...
        I’m a junior developer, passionate about building user-focused software. 
        ...
        Tailwind CSS, Prisma, Neon, and shadcn/ui. These stem from my dissertation 
        ...
        financial intricacies of a business and managing a team.
        </div>
        <div className='mt-5 text-gray-400'>
