  ...
  return (
    <div>
      <div className='block lg:hidden'>
        ...
        My interests lie in software engineering, machine learning and data analytics, 
        however, I am always open to learning something new.
        </div>
        ...
        project at university through to the passion projects I pick up to learn and practice 
